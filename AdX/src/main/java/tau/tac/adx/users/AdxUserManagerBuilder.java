 ...
 */
public class AdxUserManagerBuilder implements UserBehaviorBuilder<UserManager> {
	...
	private static final String QUERY_MANAGER_DEFAULT = "tau.tac.adx.users.AdxUserQueryManagerBuilder";
