 ...
 * 
 */
public class BasicReservePriceManager implements ReservePriceManager {
	 ...
	 */
	public BasicReservePriceManager(ConfigProxy config, double baselineRange,
	 ...
	 *            <b>reserve price</b> generated in a single day.
	 */
	public BasicReservePriceManager(double dailyBaselineAverage,
	...
	/**
	 * @see tau.tac.adx.publishers.reserve.ReservePriceManager#generateReservePrice()
	 * @param adxQuery ignored
	 */
	public synchronized double generateReservePrice(@SuppressWarnings("unused") AdxQuery adxQuery) {
		dailyRequests++;
	...
	/**
	 * @see tau.tac.adx.publishers.reserve.ReservePriceManager#addImpressionForPrice(double)
	 * @param adxQuery ignored
	 */
	public synchronized void addImpressionForPrice(double reservePrice, @SuppressWarnings("unused") AdxQuery adxQuery) {
	...
	/**
	 * @see tau.tac.adx.publishers.reserve.ReservePriceManager#updateData()
	 */
	...
	/**
	 * @see tau.tac.adx.publishers.reserve.ReservePriceManager#getMostProfitableReservePrice()
	 */
