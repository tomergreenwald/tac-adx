...
public final class Auctions {
  ...
  public interface AdxQueryOrBuilder
     ...
     */
    java.util.List<Auctions.MarketSegment> getMarketSegmentsList();
    /**
     * <code>repeated .MarketSegment marketSegments = 2;</code>
     */
     ...
     * <code>repeated .MarketSegment marketSegments = 2;</code>
     */
    Auctions.MarketSegment getMarketSegments(int index);
  ...
  public static final class AdxQuery extends
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 16: {
              ...
              Auctions.MarketSegment value = Auctions.MarketSegment.valueOf(rawValue);
              if (value == null) {
                unknownFields.mergeVarintField(2, rawValue);
              } else {
                if (!((mutable_bitField0_ & 0x00000002) == 0x00000002)) {
                  marketSegments_ = new java.util.ArrayList<Auctions.MarketSegment>();
            ...
            case 24: {
              int rawValue = input.readEnum();
              Auctions.Device value = Auctions.Device.valueOf(rawValue);
              if (value == null) {
            ...
            case 32: {
              int rawValue = input.readEnum();
              Auctions.AdType value = Auctions.AdType.valueOf(rawValue);
              if (value == null) {
    ...
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
      ...
      return Auctions.internal_static_AdxQuery_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              Auctions.AdxQuery.class, Auctions.AdxQuery.Builder.class);
    }
    ...
    private java.util.List<Auctions.MarketSegment> marketSegments_;
    /**
     * <code>repeated .MarketSegment marketSegments = 2;</code>
     */
    public java.util.List<Auctions.MarketSegment> getMarketSegmentsList() {
     ...
     * <code>repeated .MarketSegment marketSegments = 2;</code>
     */
    public Auctions.MarketSegment getMarketSegments(int index) {
      return marketSegments_.get(index);
    }

    // required .Device device = 3;
    public static final int DEVICE_FIELD_NUMBER = 3;
    private Auctions.Device device_;
    /**
     * <code>required .Device device = 3;</code>
     */
     ...
     * <code>required .Device device = 3;</code>
     */
    public Auctions.Device getDevice() {
      return device_;
    }

    // required .AdType adtype = 4;
    public static final int ADTYPE_FIELD_NUMBER = 4;
    private Auctions.AdType adtype_;
    /**
     * <code>required .AdType adtype = 4;</code>
     */
     ...
     * <code>required .AdType adtype = 4;</code>
     */
    public Auctions.AdType getAdtype() {
      return adtype_;
    }
    ...
    private void initFields() {
      ...
      device_ = Auctions.Device.MOBILE;
      adtype_ = Auctions.AdType.TEXT;
    }
    ...
    public static Auctions.AdxQuery parseFrom(
    ...
    public static Auctions.AdxQuery parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static Auctions.AdxQuery parseFrom(
    ...
    public static Auctions.AdxQuery parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static Auctions.AdxQuery parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static Auctions.AdxQuery parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(Auctions.AdxQuery prototype) {
    ...
    public static final class Builder extends
       ...
       implements Auctions.AdxQueryOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return Auctions.internal_static_AdxQuery_descriptor;
      }
      ...
      // Construct using Auctions.AdxQuery.newBuilder()
      private Builder() {
      ...
      public Auctions.AdxQuery getDefaultInstanceForType() {
        return Auctions.AdxQuery.getDefaultInstance();
      }

      public Auctions.AdxQuery build() {
        Auctions.AdxQuery result = buildPartial();
      ...
      public Auctions.AdxQuery buildPartial() {
        Auctions.AdxQuery result = new Auctions.AdxQuery(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof Auctions.AdxQuery) {
          return mergeFrom((Auctions.AdxQuery)other);
        } else {
      ...
      public Builder mergeFrom(Auctions.AdxQuery other) {
        if (other == Auctions.AdxQuery.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        Auctions.AdxQuery parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (Auctions.AdxQuery) e.getUnfinishedMessage();
          throw e;
        } finally {
  ...
  bitField0_ |= 0x00000001;
      ...
      private void ensureMarketSegmentsIsMutable() {
        if (!((bitField0_ & 0x00000002) == 0x00000002)) {
          marketSegments_ = new java.util.ArrayList<Auctions.MarketSegment>(marketSegments_);
          bitField0_ |= 0x00000002;
        }
      }
      /**
      ...
      public Builder setMarketSegments(
          int index, Auctions.MarketSegment value) {
        if (value == null) {
          throw new NullPointerException();
        }
        ensureMarketSegmentsIsMutable();
       ...
       * <code>repeated .MarketSegment marketSegments = 2;</code>
       */
      public Builder addMarketSegments(Auctions.MarketSegment value) {
        if (value == null) {
          throw new NullPointerException();
        }
        ensureMarketSegmentsIsMutable();
      ...
      public Builder addAllMarketSegments(
          java.lang.Iterable<? extends Auctions.MarketSegment> values) {
        ensureMarketSegmentsIsMutable();
      ...
      // required .Device device = 3;
      private Auctions.Device device_ = Auctions.Device.MOBILE;
      /**
       * <code>required .Device device = 3;</code>
       */
      public boolean hasDevice() {
       ...
       * <code>required .Device device = 3;</code>
       */
      public Builder setDevice(Auctions.Device value) {
        if (value == null) {
          throw new NullPointerException();
        }
        bitField0_ |= 0x00000004;
      ...
      // required .AdType adtype = 4;
      private Auctions.AdType adtype_ = Auctions.AdType.TEXT;
      /**
       * <code>required .AdType adtype = 4;</code>
       */
      public boolean hasAdtype() {
       ...
       * <code>required .AdType adtype = 4;</code>
       */
      public Builder setAdtype(Auctions.AdType value) {
        if (value == null) {
          throw new NullPointerException();
        }
  ...
  public interface AuctionReportOrBuilder
     ...
     * <code>required .AdxQuery adxQuery = 4;</code>
     */
    Auctions.AdxQuery getAdxQuery();
    /**
     * <code>required .AdxQuery adxQuery = 4;</code>
     */
    Auctions.AdxQueryOrBuilder getAdxQueryOrBuilder();
  }
  /**
  ...
  public static final class AuctionReport extends
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 34: {
              Auctions.AdxQuery.Builder subBuilder = null;
              if (((bitField0_ & 0x00000008) == 0x00000008)) {
                subBuilder = adxQuery_.toBuilder();
              }
              adxQuery_ = input.readMessage(Auctions.AdxQuery.PARSER, extensionRegistry);
              if (subBuilder != null) {
    ...
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
      ...
      return Auctions.internal_static_AuctionReport_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              Auctions.AuctionReport.class, Auctions.AuctionReport.Builder.class);
    }
    ...
    private Auctions.AdxQuery adxQuery_;
    /**
     * <code>required .AdxQuery adxQuery = 4;</code>
     */
     ...
     * <code>required .AdxQuery adxQuery = 4;</code>
     */
    public Auctions.AdxQuery getAdxQuery() {
      return adxQuery_;
    }
    /**
     * <code>required .AdxQuery adxQuery = 4;</code>
     */
    public Auctions.AdxQueryOrBuilder getAdxQueryOrBuilder() {
      return adxQuery_;
    }
    ...
    private void initFields() {
      ...
      secondsBid_ = 0D;
      reservedPrice_ = 0D;
      adxQuery_ = Auctions.AdxQuery.getDefaultInstance();
    }
    private byte memoizedIsInitialized = -1;
    public final boolean isInitialized() {
      byte isInitialized = memoizedIsInitialized;
    ...
    public static Auctions.AuctionReport parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static Auctions.AuctionReport parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static Auctions.AuctionReport parseFrom(
    ...
    public static Auctions.AuctionReport parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseFrom(input);
    }
    public static Auctions.AuctionReport parseFrom(
    ...
    public static Auctions.AuctionReport parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static Auctions.AuctionReport parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input, extensionRegistry);
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(Auctions.AuctionReport prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessage.Builder<Builder>
       implements Auctions.AuctionReportOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return Auctions.internal_static_AuctionReport_descriptor;
      }
      ...
      // Construct using Auctions.AuctionReport.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public Auctions.AuctionReport getDefaultInstanceForType() {
        return Auctions.AuctionReport.getDefaultInstance();
      }

      public Auctions.AuctionReport build() {
        Auctions.AuctionReport result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public Auctions.AuctionReport buildPartial() {
        Auctions.AuctionReport result = new Auctions.AuctionReport(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof Auctions.AuctionReport) {
          return mergeFrom((Auctions.AuctionReport)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(Auctions.AuctionReport other) {
        if (other == Auctions.AuctionReport.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        Auctions.AuctionReport parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (Auctions.AuctionReport) e.getUnfinishedMessage();
          throw e;
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
      ...
      // required .AdxQuery adxQuery = 4;
      private Auctions.AdxQuery adxQuery_ = Auctions.AdxQuery.getDefaultInstance();
      private com.google.protobuf.SingleFieldBuilder<
          Auctions.AdxQuery, Auctions.AdxQuery.Builder, Auctions.AdxQueryOrBuilder> adxQueryBuilder_;
      /**
       * <code>required .AdxQuery adxQuery = 4;</code>
       */
      public boolean hasAdxQuery() {
       ...
       * <code>required .AdxQuery adxQuery = 4;</code>
       */
      public Builder setAdxQuery(Auctions.AdxQuery value) {
        if (adxQueryBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setAdxQuery(
          Auctions.AdxQuery.Builder builderForValue) {
        if (adxQueryBuilder_ == null) {
       ...
       * <code>required .AdxQuery adxQuery = 4;</code>
       */
      public Builder mergeAdxQuery(Auctions.AdxQuery value) {
        if (adxQueryBuilder_ == null) {
          if (((bitField0_ & 0x00000008) == 0x00000008) &&
              adxQuery_ != Auctions.AdxQuery.getDefaultInstance()) {
            adxQuery_ =
              Auctions.AdxQuery.newBuilder(adxQuery_).mergeFrom(value).buildPartial();
          } else {
            adxQuery_ = value;
          }
          onChanged();
       ...
       * <code>required .AdxQuery adxQuery = 4;</code>
       */
      public Auctions.AdxQuery.Builder getAdxQueryBuilder() {
        bitField0_ |= 0x00000008;
        onChanged();
       ...
       */
      private com.google.protobuf.SingleFieldBuilder<
          Auctions.AdxQuery, Auctions.AdxQuery.Builder, Auctions.AdxQueryOrBuilder> 
          getAdxQueryFieldBuilder() {
        if (adxQueryBuilder_ == null) {
  ...
  public interface DataBundleOrBuilder
     ...
     */
    java.util.List<Auctions.AuctionReport> 
        getReportsList();
    /**
     * <code>repeated .AuctionReport reports = 1;</code>
     */
    Auctions.AuctionReport getReports(int index);
    /**
     * <code>repeated .AuctionReport reports = 1;</code>
     */
    int getReportsCount();
     ...
     * <code>repeated .AuctionReport reports = 1;</code>
     */
    java.util.List<? extends Auctions.AuctionReportOrBuilder> 
        getReportsOrBuilderList();
    /**
     * <code>repeated .AuctionReport reports = 1;</code>
     */
    Auctions.AuctionReportOrBuilder getReportsOrBuilder(
        int index);
  }
  /**
  ...
  public static final class DataBundle extends
          ...
          switch (tag) {
            ...
            case 10: {
              if (!((mutable_bitField0_ & 0x00000001) == 0x00000001)) {
                reports_ = new java.util.ArrayList<Auctions.AuctionReport>();
                mutable_bitField0_ |= 0x00000001;
              }
              reports_.add(input.readMessage(Auctions.AuctionReport.PARSER, extensionRegistry));
              break;
            }
          }
        }
    ...
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
      ...
      return Auctions.internal_static_DataBundle_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              Auctions.DataBundle.class, Auctions.DataBundle.Builder.class);
    }
    ...
    private java.util.List<Auctions.AuctionReport> reports_;
    /**
     * <code>repeated .AuctionReport reports = 1;</code>
     */
    public java.util.List<Auctions.AuctionReport> getReportsList() {
      return reports_;
    }
    /**
     * <code>repeated .AuctionReport reports = 1;</code>
     */
    public java.util.List<? extends Auctions.AuctionReportOrBuilder> 
        getReportsOrBuilderList() {
      return reports_;
    }
    /**
     ...
     * <code>repeated .AuctionReport reports = 1;</code>
     */
    public Auctions.AuctionReport getReports(int index) {
      return reports_.get(index);
    }
    /**
     * <code>repeated .AuctionReport reports = 1;</code>
     */
    public Auctions.AuctionReportOrBuilder getReportsOrBuilder(
        int index) {
      return reports_.get(index);
    }
    ...
    public static Auctions.DataBundle parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static Auctions.DataBundle parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static Auctions.DataBundle parseFrom(
    ...
    public static Auctions.DataBundle parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseFrom(input);
    }
    public static Auctions.DataBundle parseFrom(
    ...
    public static Auctions.DataBundle parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static Auctions.DataBundle parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input, extensionRegistry);
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(Auctions.DataBundle prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessage.Builder<Builder>
       implements Auctions.DataBundleOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return Auctions.internal_static_DataBundle_descriptor;
      }
      ...
      // Construct using Auctions.DataBundle.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public Auctions.DataBundle getDefaultInstanceForType() {
        return Auctions.DataBundle.getDefaultInstance();
      }

      public Auctions.DataBundle build() {
        Auctions.DataBundle result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public Auctions.DataBundle buildPartial() {
        Auctions.DataBundle result = new Auctions.DataBundle(this);
        int from_bitField0_ = bitField0_;
        if (reportsBuilder_ == null) {
          if (((bitField0_ & 0x00000001) == 0x00000001)) {
            reports_ = java.util.Collections.unmodifiableList(reports_);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof Auctions.DataBundle) {
          return mergeFrom((Auctions.DataBundle)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(Auctions.DataBundle other) {
        if (other == Auctions.DataBundle.getDefaultInstance()) return this;
        if (reportsBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        Auctions.DataBundle parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (Auctions.DataBundle) e.getUnfinishedMessage();
          throw e;
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
      ...
      private void ensureReportsIsMutable() {
        if (!((bitField0_ & 0x00000001) == 0x00000001)) {
          reports_ = new java.util.ArrayList<Auctions.AuctionReport>(reports_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilder<
          Auctions.AuctionReport, Auctions.AuctionReport.Builder, Auctions.AuctionReportOrBuilder> reportsBuilder_;
      ...
      public Builder setReports(
          int index, Auctions.AuctionReport value) {
        if (reportsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setReports(
          int index, Auctions.AuctionReport.Builder builderForValue) {
        if (reportsBuilder_ == null) {
          ensureReportsIsMutable();
       ...
       * <code>repeated .AuctionReport reports = 1;</code>
       */
      public Builder addReports(Auctions.AuctionReport value) {
        if (reportsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addReports(
          Auctions.AuctionReport.Builder builderForValue) {
        if (reportsBuilder_ == null) {
          ensureReportsIsMutable();
      ...
      public Builder addAllReports(
          java.lang.Iterable<? extends Auctions.AuctionReport> values) {
        if (reportsBuilder_ == null) {
          ensureReportsIsMutable();
       ...
       * <code>repeated .AuctionReport reports = 1;</code>
       */
      public Auctions.AuctionReport.Builder getReportsBuilder(
          int index) {
       ...
       * <code>repeated .AuctionReport reports = 1;</code>
       */
      public Auctions.AuctionReport.Builder addReportsBuilder() {
        return getReportsFieldBuilder().addBuilder(
            Auctions.AuctionReport.getDefaultInstance());
      }
      /**
       * <code>repeated .AuctionReport reports = 1;</code>
       */
      public Auctions.AuctionReport.Builder addReportsBuilder(
          int index) {
        return getReportsFieldBuilder().addBuilder(
            index, Auctions.AuctionReport.getDefaultInstance());
      }
      /**
       * <code>repeated .AuctionReport reports = 1;</code>
       */
      public java.util.List<Auctions.AuctionReport.Builder> 
           getReportsBuilderList() {
        return getReportsFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilder<
          Auctions.AuctionReport, Auctions.AuctionReport.Builder, Auctions.AuctionReportOrBuilder> 
          getReportsFieldBuilder() {
        if (reportsBuilder_ == null) {
  ...
  public interface ReservePriceManagerBundleOrBuilder
    ...
    // required .AdxQuery adxQueries = 1;
    /**
     * <code>required .AdxQuery adxQueries = 1;</code>
     */
    boolean hasAdxQueries();
    /**
     * <code>required .AdxQuery adxQueries = 1;</code>
     */
    Auctions.AdxQuery getAdxQueries();
    /**
     * <code>required .AdxQuery adxQueries = 1;</code>
     */
    Auctions.AdxQueryOrBuilder getAdxQueriesOrBuilder();
  ...
  public static final class ReservePriceManagerBundle extends
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10: {
              Auctions.AdxQuery.Builder subBuilder = null;
              if (((bitField0_ & 0x00000001) == 0x00000001)) {
                subBuilder = adxQueries_.toBuilder();
              }
              adxQueries_ = input.readMessage(Auctions.AdxQuery.PARSER, extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom(adxQueries_);
                adxQueries_ = subBuilder.buildPartial();
              }
              bitField0_ |= 0x00000001;
              break;
            }
    ...
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
      ...
      return Auctions.internal_static_ReservePriceManagerBundle_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              Auctions.ReservePriceManagerBundle.class, Auctions.ReservePriceManagerBundle.Builder.class);
    }
    ...
    private int bitField0_;
    // required .AdxQuery adxQueries = 1;
    public static final int ADXQUERIES_FIELD_NUMBER = 1;
    private Auctions.AdxQuery adxQueries_;
    /**
     * <code>required .AdxQuery adxQueries = 1;</code>
     */
    public boolean hasAdxQueries() {
      return ((bitField0_ & 0x00000001) == 0x00000001);
    }
    /**
     * <code>required .AdxQuery adxQueries = 1;</code>
     */
    public Auctions.AdxQuery getAdxQueries() {
      return adxQueries_;
    }
    /**
     * <code>required .AdxQuery adxQueries = 1;</code>
     */
    public Auctions.AdxQueryOrBuilder getAdxQueriesOrBuilder() {
      return adxQueries_;
    }
    ...
    private void initFields() {
      adxQueries_ = Auctions.AdxQuery.getDefaultInstance();
      reservePrice_ = 0F;
    }
    private byte memoizedIsInitialized = -1;
    public final boolean isInitialized() {
      ...
      if (!getAdxQueries().isInitialized()) {
        memoizedIsInitialized = 0;
        return false;
      }
      memoizedIsInitialized = 1;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      getSerializedSize();
      if (((bitField0_ & 0x00000001) == 0x00000001)) {
        output.writeMessage(1, adxQueries_);
      }
      if (((bitField0_ & 0x00000002) == 0x00000002)) {
    ...
    public int getSerializedSize() {
      ...
      if (((bitField0_ & 0x00000001) == 0x00000001)) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1, adxQueries_);
      }
      if (((bitField0_ & 0x00000002) == 0x00000002)) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public static Auctions.ReservePriceManagerBundle parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static Auctions.ReservePriceManagerBundle parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static Auctions.ReservePriceManagerBundle parseFrom(
    ...
    public static Auctions.ReservePriceManagerBundle parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseFrom(input);
    }
    public static Auctions.ReservePriceManagerBundle parseFrom(
    ...
    public static Auctions.ReservePriceManagerBundle parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static Auctions.ReservePriceManagerBundle parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input, extensionRegistry);
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(Auctions.ReservePriceManagerBundle prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessage.Builder<Builder>
       implements Auctions.ReservePriceManagerBundleOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return Auctions.internal_static_ReservePriceManagerBundle_descriptor;
      }
      ...
      // Construct using Auctions.ReservePriceManagerBundle.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public Builder clear() {
        super.clear();
        if (adxQueriesBuilder_ == null) {
          adxQueries_ = Auctions.AdxQuery.getDefaultInstance();
        } else {
          adxQueriesBuilder_.clear();
        }
        bitField0_ = (bitField0_ & ~0x00000001);
        reservePrice_ = 0F;
        bitField0_ = (bitField0_ & ~0x00000002);
      ...
      public Auctions.ReservePriceManagerBundle getDefaultInstanceForType() {
        return Auctions.ReservePriceManagerBundle.getDefaultInstance();
      }

      public Auctions.ReservePriceManagerBundle build() {
        Auctions.ReservePriceManagerBundle result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public Auctions.ReservePriceManagerBundle buildPartial() {
        Auctions.ReservePriceManagerBundle result = new Auctions.ReservePriceManagerBundle(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
        ...
        if (adxQueriesBuilder_ == null) {
          result.adxQueries_ = adxQueries_;
        } else {
          result.adxQueries_ = adxQueriesBuilder_.build();
        }
        if (((from_bitField0_ & 0x00000002) == 0x00000002)) {
          to_bitField0_ |= 0x00000002;
        }
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof Auctions.ReservePriceManagerBundle) {
          return mergeFrom((Auctions.ReservePriceManagerBundle)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(Auctions.ReservePriceManagerBundle other) {
        if (other == Auctions.ReservePriceManagerBundle.getDefaultInstance()) return this;
        if (other.hasAdxQueries()) {
          mergeAdxQueries(other.getAdxQueries());
        }
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        Auctions.ReservePriceManagerBundle parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (Auctions.ReservePriceManagerBundle) e.getUnfinishedMessage();
          throw e;
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
      ...
      // required .AdxQuery adxQueries = 1;
      private Auctions.AdxQuery adxQueries_ = Auctions.AdxQuery.getDefaultInstance();
      private com.google.protobuf.SingleFieldBuilder<
          Auctions.AdxQuery, Auctions.AdxQuery.Builder, Auctions.AdxQueryOrBuilder> adxQueriesBuilder_;
      /**
       * <code>required .AdxQuery adxQueries = 1;</code>
       */
      public boolean hasAdxQueries() {
      ...
      public Auctions.AdxQuery getAdxQueries() {
        if (adxQueriesBuilder_ == null) {
          ...
          return adxQueriesBuilder_.getMessage();
        }
      }
      /**
       * <code>required .AdxQuery adxQueries = 1;</code>
       */
      public Builder setAdxQueries(Auctions.AdxQuery value) {
        if (adxQueriesBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
          ...
          adxQueriesBuilder_.setMessage(value);
        }
        bitField0_ |= 0x00000001;
        return this;
      }
       ...
       * <code>required .AdxQuery adxQueries = 1;</code>
       */
      public Builder setAdxQueries(
          Auctions.AdxQuery.Builder builderForValue) {
        if (adxQueriesBuilder_ == null) {
          adxQueries_ = builderForValue.build();
          onChanged();
        } else {
          adxQueriesBuilder_.setMessage(builderForValue.build());
        }
        bitField0_ |= 0x00000001;
        return this;
      }
       ...
       * <code>required .AdxQuery adxQueries = 1;</code>
       */
      public Builder mergeAdxQueries(Auctions.AdxQuery value) {
        if (adxQueriesBuilder_ == null) {
          if (((bitField0_ & 0x00000001) == 0x00000001) &&
              adxQueries_ != Auctions.AdxQuery.getDefaultInstance()) {
            adxQueries_ =
              Auctions.AdxQuery.newBuilder(adxQueries_).mergeFrom(value).buildPartial();
          } else {
            adxQueries_ = value;
          }
          onChanged();
        } else {
          adxQueriesBuilder_.mergeFrom(value);
        }
        bitField0_ |= 0x00000001;
        return this;
      }
       ...
       * <code>required .AdxQuery adxQueries = 1;</code>
       */
      public Builder clearAdxQueries() {
        if (adxQueriesBuilder_ == null) {
          adxQueries_ = Auctions.AdxQuery.getDefaultInstance();
          onChanged();
        } else {
       ...
       * <code>required .AdxQuery adxQueries = 1;</code>
       */
      public Auctions.AdxQuery.Builder getAdxQueriesBuilder() {
        bitField0_ |= 0x00000001;
        onChanged();
        return getAdxQueriesFieldBuilder().getBuilder();
      }
      /**
       * <code>required .AdxQuery adxQueries = 1;</code>
       */
      public Auctions.AdxQueryOrBuilder getAdxQueriesOrBuilder() {
        if (adxQueriesBuilder_ != null) {
          return adxQueriesBuilder_.getMessageOrBuilder();
        } else {
          return adxQueries_;
        }
      }
      ...
      private com.google.protobuf.SingleFieldBuilder<
          ...
          getAdxQueriesFieldBuilder() {
        if (adxQueriesBuilder_ == null) {
          adxQueriesBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              Auctions.AdxQuery, Auctions.AdxQuery.Builder, Auctions.AdxQueryOrBuilder>(
                  adxQueries_,
                  getParentForChildren(),
                  isClean());
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ctionReport\"P\n\031ReservePriceManagerBundle" +
      "\022\035\n\nadxQueries\030\001 \002(\0132\t.AdxQuery\022\024\n\014reser" +
      "vePrice\030\002 \002(\002*Z\n\rMarketSegment\022\010\n\004MALE\020\000",
      "\022\n\n\006FEMALE\020\001\022\t\n\005YOUNG\020\002\022\007\n\003OLD\020\003\022\016\n\nLOW_" +
      "INCOME\020\004\022\017\n\013HIGH_INCOME\020\005*\034\n\006Device\022\n\n\006M" +
      "OBILE\020\000\022\006\n\002PC\020\001*\035\n\006AdType\022\010\n\004TEXT\020\000\022\t\n\005V" +
      "IDEO\020\001"
    };
      ...
      new com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_ReservePriceManagerBundle_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_ReservePriceManagerBundle_descriptor,
              new java.lang.String[] { "AdxQueries", "ReservePrice", });
          return null;
        }
      };
